...
data object DocumentationAgent : AgentDefinition() {
    ...
    override val prompt: String
        get() = instructionsFrom(docType, targetAudience)
    ...
    override fun parseInputs(inputs: Map<String, AgentInput>) {
        docType = inputs[docTypeArg.key]?.value ?: "API Documentation"
        targetAudience = inputs[audienceArg.key]?.value ?: "Developers"
    }

    private fun instructionsFrom(docType: String, audience: String): String = """
