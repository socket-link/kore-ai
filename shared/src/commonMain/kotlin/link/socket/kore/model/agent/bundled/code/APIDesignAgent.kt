...
data object APIDesignAgent : AgentDefinition() {
    ...
    override val name: String = "API Design"

    override val prompt: String
        get() = instructionsFrom(reviewType, designPrinciple)
    ...
    override fun parseInputs(inputs: Map<String, AgentInput>) {
        reviewType = inputs[reviewTypeArg.key]?.value ?: "Public API Review"
        designPrinciple = inputs[principleArg.key]?.value ?: "Kotlin Idioms"
    }

    private fun instructionsFrom(reviewType: String, principle: String): String = """
