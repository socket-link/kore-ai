...
data object ReleaseManagementAgent : AgentDefinition() {

    private var releaseType: String = "Minor Release"
    private var versionScheme: String = "Semantic Versioning"
    ...
    override val name: String = "Release Management"

    override val prompt: String
        get() = instructionsFrom(releaseType, versionScheme)
    ...
    override fun parseInputs(inputs: Map<String, AgentInput>) {
        releaseType = inputs[releaseTypeArg.key]?.value ?: "Minor Release"
        versionScheme = inputs[versionSchemeArg.key]?.value ?: "Semantic Versioning"
    }

    private fun instructionsFrom(releaseType: String, versionScheme: String): String = """
