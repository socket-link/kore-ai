...
data object PlatformCompatibilityAgent : AgentDefinition() {
    ...
    override val name: String = "Platform Compatibility"

    override val prompt: String
        get() = instructionsFrom(targetPlatforms, checkType)
    ...
    override fun parseInputs(inputs: Map<String, AgentInput>) {
        targetPlatforms = inputs[platformsArg.key]?.value ?: "All Platforms"
        checkType = inputs[checkTypeArg.key]?.value ?: "API Compatibility"
    }

    private fun instructionsFrom(platforms: String, checkType: String): String = """
